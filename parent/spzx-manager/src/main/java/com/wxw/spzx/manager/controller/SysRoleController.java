...
import com.wxw.spzx.common.log.enums.OperatorType;
...
public class SysRoleController {
    ...
    public Result<PageInfo<SysRole>> findByPage(@PathVariable(value = "current") Integer pageNum ,
    ...
    @Log(title = "角色添加",businessType = 1,operatorType = OperatorType.MANAGE) //添加Log注解，设置属性
